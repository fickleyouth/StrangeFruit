...
class SearchViewer extends BuildHTML {
	...
	//output all cells
	$item_search_content = $item_row_start.$item_title_cell.$item_desc_cell;
	$item_content_cell = $item_text_cell.$item_img_cell.$item_map_cell;
	$content_link_cell = $text_link_cell.$img_link_cell.$map_link_cell;
	self::$search_content .= $item_search_content.$item_content_cell.$content_link_cell.$row_end;
	}
